...
private:
	...
	// Hold 1 predefined Chord palette
	ChordPaletteContainer* predefinedChordPalettes;
	TChordPalette* palett;
	bool storePalett;
...
private:
	...
	void importCurrentChordPalette();
	void exportCurrentChordPalette();
