...
const char* FileExtProvider::chordsExtensions[] = 
{
	"gco","Guitar chords",
	NULL, NULL
};
...
{
//	return fillList(colorExtensions, ExtensionTypeColor);
...
const char* const* FileExtProvider::getChordExtensions()
{
//	return fillList(chordsExtensions, ExtensionTypeChords);
	return chordsExtensions;
}

const char* FileExtProvider::getChordExtension(ChordsExtensions extension) { return chordsExtensions[extension*2]; }
const char* FileExtProvider::getChordDescription(ChordsExtensions extension) { return chordsExtensions[extension*2+1]; }	
