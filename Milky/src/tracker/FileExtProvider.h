...
private:
	...
	static const char* chordsExtensions[];
...
public:
	...
	const char* const* getChordExtensions();
	const char* getChordExtension(ChordsExtensions extension);
	const char* getChordDescription(ChordsExtensions extension);
};
