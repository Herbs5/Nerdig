...
void SectionSamples::init(pp_int32 x, pp_int32 y)
{
	...
	{
//#ifndef __LOWRES__
	pp_int32 conSize1 = (pp_int32)(wii*0.1359375f);
	pp_int32 conSize2 = (pp_int32)(wii*0.215625f);
	pp_int32 conSize3 = (pp_int32)(wii*0.0734375f);
	pp_int32 conSize4 = (pp_int32)(wii*0.075f);
	pp_int32 conSize5 = (pp_int32)(wii*0.128125f);
	pp_int32 conSize6 = (pp_int32)(wii*0.103125f);
	pp_int32 conSize7 = (pp_int32)(wii*0.2525f);
...
#ifdef __LOWRES__
				control->show(false);
				pp_int32 hii = screen->getHeight();
				if( hii >=321)
						replaceInstrumentListBoxes(true, 156);
				else if( hii >=261)
						replaceInstrumentListBoxes(true, 110);
				else		
