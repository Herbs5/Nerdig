...
struct PPChord
{
	pp_int32 E,a,d,g,b,e;

	PPChord(pp_int32 Eine, pp_int32 alte, pp_int32 dame, pp_int32 geht, pp_int32 beeren, pp_int32 essen) :
		E(Eine), a(alte), d(dame), g(geht), b(beeren), e(essen)
	{}
	...
	void set(pp_int32 Eine, pp_int32 alte, pp_int32 dame,  pp_int32 geht, pp_int32 beeren, pp_int32 essen)
	{
		E = Eine, a = alte, d = dame, g = geht, b = beeren, e = essen;
	}
	...
	void operator+=(const PPChord& source)
	{
		E+=source.E;
		a+=source.a;
		d+=source.d;
	...
	bool operator==(const PPChord& source) const
	{
		return (E == source.E &&  a== source.a && d == source.d && g == source.g && b == source.b && e == source.e);
	}
