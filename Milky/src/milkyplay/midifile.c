...
//static 
char* tran_inst(int patch)
{

/* Names of the patches available to timidity.  Some of these voices are 
not available in freepats.  But it seems like a good idea to make them 
available anyway, so that this limitation lies outside of the program 
rather than inherent in it.  Names here follow freepats where available, 
Yamaha, elsewhere. */

  static char *strings[] = 

  { 
"Piano", "Brite Piano", "Electric G Piano", "Honky-tonk Piano", 
"Electric Piano 1", "Electric Piano 2", "Harpsichord", "Clavinet", 
"Celesta", "Glockenspiel", "Music Box", "Vibraphone", "Marimba", 
"Xylophone", "Tubular Bells", "Dulcimer", "Hammond Organ", "Percussive \
Organ", "Rock Organ", "Church Organ", "Reed Organ", "Accordion", 
"Harmonica", "Tango Accordion", "Nylon Guitar", "Steel Guitar", "Jazz \
Guitar", "Clean Electric Guitar", "Muted Electric Guitar", "Overdriven \
Guitar", "Distortion Guitar", "Guitar Harmonics", "Acoustic Bass", 
"Finger Bass", "Pick Bass", "Fretless Bass", "Slap Bass 1", "Slap Bass \
2", "Synth Bass 1", "Synth Bass 2", "Violin", "Viola", "Cello", 
"Contrabass", "Tremolo Strings", "Pizzicato Strings", "Harp", "Timpani", 
"String Ensemble", "String Ensemble 2", "Synth Strings 1", "Synth \
Strings 2", "Choir Aahs", "Voice Oohs", "Synth Voice", "Orchestra Hit", 
"Trumpet", "Trombone", "Tuba", "Muted Trumpet", "French Horn", "Brass \
Section", "Synth Brass 1", "Synth Brass 2", "Soprano Sax", "Alto Sax", 
"Tenor Sax", "Baritone Sax", "Oboe", "English Horn", "Bassoon", 
"Clarinet", "Piccolo", "Flute", "Recorder", "Panpipe", "Bottle Blow", 
"Shakuhachi", "Whistle", "Ocarina", "Square Wave", "Sawtooth Lead", 
"Calliope Lead", "Chiff Lead", "Charang Lead", "Voice Lead", "Fifth \
Lead", "Bass+Lead", "New Age", "Warm Pad", "Polysynth Pad", "Choir Pad", 
"Bowed Pad", "Metallic Pad", "Halo Pad", "Sweep Pad", "Rain", 
"Soundtrack", "Crystal", "Atmosphere", "Brightness", "Goblins-Unicorn", 
"Echo Voice", "Sci-Fi", "Sitar", "Banjo", "Shamisen", "Koto", "Kalimba", 
"Bagpipe", "Fiddle", "Shanai", "Tinkle Bell", "Agogo", "Steel Drums", 
"Wood Block", "Taiko Drum", "Melodic Drum", "Synth Drum", "Reverse \
Cymbal", "Fret Noise", "Breath Noise", "Seashore", "Bird Tweet", 
"Telephone Ring", "Helicopter", "Applause", "Gunshot"
  } ;

  return strings[patch] ;

} /* End Function *tran_inst() */
			...
			while ((ftell(in) < chunk_start + chunk_size) && !at_end_of_track)
			{
				...
				switch (status & 0xF0)  //  hi
				{
					...
					case 0x90:
					{
						...
						else if( velocity == 0)  ;  //  silent  , may be noteoff
						else
						{
							instrument = midichannel.instrument
						}*/
					...
					case 0xC0:  // program change - (instrument/voice selection)
					...
					case 0xF0:
					{
						...
						/*		{
								...
								printf(" meta-even %i,  %s", value , data_buffer);
								switch (value) 
								{
									case 0x1: // text
									case 0x2: // copyright
									...
									case 0x4: // instrument name
										printf("instrument name  %s ", data_buffer);
										break;
									case 0x5: // lyric
									case 0x6: // marker
									case 0x7: // cue point
