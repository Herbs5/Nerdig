...
LOCAL_CFLAGS := $(foreach D, $(CG_SUBDIRS), -I$(LOCAL_PATH)/$(D)) \
				...
				-DHAVE_CONFIG_H -DMILKYTRACKER -D__THREADTIMER__ -DDRIVER_UNIX -D_GNU_SOURCE=1 -D_REENTRANT -D__FORCE_SDL_AUDIO__ -D__LOWRES__

#Change C++ file extension as appropriate      
LOCAL_CPP_EXTENSION := .cpp

LOCAL_SRC_FILES := $(foreach F, $(CG_SUBDIRS), $(addprefix $(F)/,$(notdir $(wildcard $(LOCAL_PATH)/$(F)/*.cpp))))
LOCAL_SRC_FILES += src/ppui/osinterface/posix/PPSystem_POSIX.cpp src/ppui/osinterface/posix/PPPath_POSIX.cpp src/milkyplay/midifile.c
