...
public class MainActivity extends Activity {
 ...
 //	File sdDirectory = new File("/sdcard"); 	//Do not hardcode "/sdcard/"; 
	...
	////
		...
		File sdDirectory = new File(Environment.getExternalStorageDirectory().getPath());
...
class DemoGLSurfaceView extends GLSurfaceView {
	...
	if (action >= 0) {
	    ...
	    //int nativeH = 480;
		//  %
	    int x = (int) event.getX() * 100 /  w;
	    int y = (int) event.getY() * 100 / h;
